...
- `scripts.js`: galeria completa, filtros, zoom, navegacao e demais interacoes.
- `assets/`: logo e imagem principal do site.
- `portifolio/`: arquivos JPG originais, videos e negativos digitais DNG.
- `robots.txt` e `sitemap.xml`: arquivos basicos para indexacao.

## Contato

WhatsApp: (41) 98453-7827
